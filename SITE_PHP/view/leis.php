...
<body>
    <main>
        <section class="home">
            ...
            <div class="home-imgs">
                <img src="../img/retrospectiva-mulheres.jpg" alt="mulher">
            </div>
        </section>
    </main> <!--end header-->
    ...
    <section class="sobre">
        <div class="interface">
            <div class="flex">
                ...
                <div id="destino" class="txt-sobre">
    ...
    <section class="direitos-do-site">
        <div class="interface">
        <h1 class="text-h1">LEIS DE <span>PROTEÇÂO</span> À <span>MULHER</span></h1>
            <div class="flex">
                ...
                <div class="img-direitos-site">
                    <img src="../img/mulher-ajudando.png" alt="">
    ...
    <script>
        ...
        function scrollToDestinoLento() {
            var targetPosition = document.getElementById("destino").offsetTop - 350; // Adicionando um deslocamento de 50px para cima
