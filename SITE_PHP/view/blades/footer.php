  ...
  <li class="icon-content">
    ...
    <div class="tooltip">Facebook</div>
            ...
            <ul class="footer-list">
                ...
                <li>
                    <a href="#" class="footer-link">Geovanna: Mobile developer <> UX/UI Designer</a>
                </li>
                <li>
                    <a href="https://github.com/AnakellySantosMascarenhas" class="footer-link">Ana Kelly: Redator <> Desktop <> UX/UI Designer</a>
                </li>
                <li>
                    <a href="https://github.com/gsfsilva" class="footer-link">Gustavo: UX/UI Designer</a>
                </li>
            </ul>
